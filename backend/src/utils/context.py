...
# this script returns the text context for a given entity mention in the manuscript, to be used as input for the classification step.
...
def get_entity_context(entity: str, text: str, window=1):
    ...
    return hits[:2]  # adjust number of contexts returned as needed